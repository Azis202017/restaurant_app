...
<html lang="en">
    <head>
        ...
        <!-- Nucleo Icons -->
        <link
            href="{{ asset('assets/admin/assets/css/nucleo-icons.css') }}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('assets/admin/assets/css/nucleo-svg.css') }}"
            rel="stylesheet"
        />
        <!-- Font Awesome Icons -->
        <script
        ...
        <link
            id="pagestyle"
            href="{{ asset('assets/admin/assets/css/argon-dashboard.css?v=2.0.4') }}"
            rel="stylesheet"
        />
    </head>
    ...
    <body class="g-sidenav-show bg-gray-100">
        ...
        >
            <div class="sidenav-header">
                ...
                >
                    <img
                        src="{{ asset('assets/admin/assets/img/logo-ct-dark.png') }}"
                        class="navbar-brand-img h-100"
                        alt="main_logo"
                    />
                    <span class="ms-1 font-weight-bold">Yummy</span>
                </a>
            </div>
            ...
            >
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('resep') ? 'active' : '' }}" href="{{ route('resep') }}" >
                            <div
            ...
            <div class="card shadow-lg">
                <div class="card-header pb-0 pt-3">
                    <div class="float-start">
                        <h5 class="mt-3 mb-0">Yummy Configurator</h5>
        ...
        <script src="{{ asset('assets/admin/assets/js/argon-dashboard.min.js?v=2.0.4') }}"></script>
    </body>
</html>
